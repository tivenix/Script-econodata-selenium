...
driver = webdriver.Chrome(PATH,chrome_options=options) #navegador
...
for i in range(1,len(CNPJ)):
    ...
    driver.find_element(By.XPATH,"/html/body/div/div/div/div[2]/div/div[1]/div/div/div[2]/div/div/div[2]/div[2]/form/div[1]/div/input").send_keys(CNPJ[x+1])
    driver.implicitly_wait(1)   
    ...
    WebDriverWait(driver,10).until(EC.element_to_be_clickable((By.XPATH,"/html/body/div[2]/div/div/div[2]/div/div[3]/div[2]/div/div[2]/div/div/div/div/div/div/div/div/table/tbody/tr/td[5]/a"))).click()
    driver.implicitly_wait(2),
    print(CNPJ[x+ 1],opçao,"Dentro do loop")